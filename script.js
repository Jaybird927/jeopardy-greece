...
function awardPoints(team) {
    if (currentQuestion) {
        ...
        currentQuestion.clueElement.innerHTML = `<img src="${teamImages[team]}" alt="${team}" style="width: 4vh; height: 4vh; border-radius: 50%; object-fit: cover;">`;
...
function markIncorrect() {
    if (currentQuestion) {
        ...
        currentQuestion.clueElement.innerHTML = `<img src="incorrect.jpg" alt="incorrect" style="width: 4vh; height: 4vh; border-radius: 50%; object-fit: cover;">`;
